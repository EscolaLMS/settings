...
return [
    SettingsPermissionsEnum::SETTINGS_MANAGE => 'Manage setting',
    SettingsPermissionsEnum::SETTINGS_CREATE => 'Create settings',
    SettingsPermissionsEnum::SETTINGS_DELETE => 'Delete settings',
